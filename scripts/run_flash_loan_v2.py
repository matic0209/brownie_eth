from brownie import FlashloanV2, accounts, config, interface, network
...
def main():
    ...
    network_new = config["networks"][network.show_active()]["weth"]
    weth = interface.WethInterface(network_new)
